        ...
        <div class="container">
            <div class='card mt-4'>
                <div class='card-header'>
                    <h2>Add New Book
                        <a href="<?php echo e(route('listbook')); ?>" class='btn btn-primary btn-sm float-end' style='marginTop:8px'>All Books</a>
                    </h2>
                </div>
                <div class='card-body'>
                    ...
                    <?php if(Session::has('err_message')): ?>
                        <div class="alert alert-danger" role="alert"><?php echo e(Session::get('err_message')); ?></div>
                    <?php endif; ?>
                    <?php if(Session::has('loginmessage')): ?>
                    <div class="alert alert-danger" role="alert"><?php echo e(Session::get('loginmessage')); ?></div>
                    <?php endif; ?>
                        ...
                        <div class="row">
                            ...
                            <div class='form-group mb-3 col-md-4'>
                                ...
                                <div class="slider">
                                    ...
                                    <input type="text" id="trade_price" name="trade_price" class='form-control' style="width: 60px" value="<?php echo e($trade_price); ?>" disabled required />
                                </div>
                            </div>
                            <div class='form-group mb-3 col-md-4'>
                                ...
                                <div class="slider">
                                    ...
                                    <input type="text" id="retail_price" name="retail_price" class='form-control' style="width: 60px" value="<?php echo e($retail_price); ?>" disabled required />
                                </div>
                            </div>
                            <div class='form-group mb-3 col-md-4'>
                                ...
                                <div class="slider">
                                    ...
                                    <input type="text" id="quantity" name="quantity" class='form-control' style="width: 60px" value="<?php echo e($quantity); ?>" disabled required />
                                </div>
                            </div>
...
<?php /**PATH D:\Laragon\www\agiledev\resources\views/livewire/admin-add-book-component.blade.php ENDPATH**/ ?>