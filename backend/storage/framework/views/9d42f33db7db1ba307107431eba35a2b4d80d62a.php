<div>
    <div class='container-fluid' style="background-image: url('<?php echo e(asset('assets/images/adventure.jpg')); ?>'); background-repeat:no-repeat; background-size:cover">
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img src=<?php echo e(asset('assets/images/banner.jpeg')); ?> class="d-block w-100" alt="...">
                          </div>
                ...
                <div class='row row-cols-2 row-cols-lg-4 g-2 g-lg-4' >
                  <?php if(@$books): ?>
                      ...
                      <div style='text-align:center'>
                        <img src="<?php echo e(asset('assets/uploaded_images/books')); ?>/<?php echo e($row->image); ?>" style='display:block; margin:auto; width:150px; height:250px; border-radius:20px' />
                        <h6 class='font-genre' style='font-size:25px; height:60px'><?php echo e($row->title); ?></h6>
                        <h6 class='font-genre' style='font-size:15px'><?php echo e($row->author); ?></h6>
                        <h6 class='font-genre' style='font-size:20px'>RM <?php echo e($row->retail_price); ?></h6>
...
<?php /**PATH D:\Laragon\www\agiledev\resources\views/livewire/adventure-component.blade.php ENDPATH**/ ?>