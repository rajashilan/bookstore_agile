                ...
                <div class='row row-cols-2 row-cols-lg-4 g-2 g-lg-4' >
                  @if ($books)
                      ...
                      <div style='text-align:center'>
                        ...
                        <button type='button' class='btn btn-sm' style='background-color: #3B89FD; color:#fff; border-color:transparent'><span style='margin-right:8px'><i class="fa-solid fa-cart-shopping"></i></span>Add to Cart</button>
                      </div>
                  @endforeach 
                  @else
